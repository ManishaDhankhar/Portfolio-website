...
const About = () => {
    ...
    const [bio, setBio] = useState("I'm an engineering student at Kurukshetra University with a passion for building user-friendly web applications using the MERN stack. I've honed my problem-solving skills in competitive environments, including a Microsoft hackathon where my team reached the semi-finals. I'm now looking to apply my technical skills to real-world challenges.");
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-shrink-0">
                        <img 
                            src={myPhoto} 
                            alt="A professional photo of Manisha Dhankhar"
